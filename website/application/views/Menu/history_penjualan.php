                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <?php
                                if (isset($_GET['tanggal'])) {
                                    ...
                                    $sql = mysqli_query($koneksi, "SELECT * FROM tb_detail_transaksi WHERE tanggal =  EXISTS (SELECT * FROM tb_transaksi WHERE tb_transaksi.id_transaksi = tb_detail_transaksi.id_transaksi)");
                                }
