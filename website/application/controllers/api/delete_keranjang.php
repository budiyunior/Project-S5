...
class delete_keranjang extends REST_Controller
{
    ...
    function index_post()
    {
        ...
        $keranjang = $this->db->query("DELETE FROM tb_keranjang WHERE id_transaksi=$id_trans AND id_produk=$id_produk")->row_array();
